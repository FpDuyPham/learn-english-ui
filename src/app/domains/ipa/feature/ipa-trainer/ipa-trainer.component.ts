...
import { IpaDataService, IpaSound, IpaWord } from '../../data/ipa-data.service';
import { SmartIpaTrainerComponent } from '../../ui/smart-ipa-trainer/smart-ipa-trainer.component';

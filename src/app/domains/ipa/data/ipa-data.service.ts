...
export interface UserIpaProgress {
    ...
    lastPracticed?: Date;
    plantStage: number; // 0=Seed, 1=Sprout, 2=Plant, 3=Tree
    xp: number;
}
// Alias for component compatibility
export type IpaSymbol = IpaSound;
...
export class IpaDataService {
    ...
    getProgress(symbol: string, level: number = 1): UserIpaProgress {
